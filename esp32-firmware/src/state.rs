...
// Generated by build.rs: 10^((RSSI_REF - rssi) / (10*PATH_LOSS_N)) as I16F16 bits for rssi in -128..=127
...
pub struct NodeState {
    ...
    pub node_ids: HashMap<[u8; 6], heapless::String<{ crate::topology::NODE_ID_LEN }>>,
}
...
impl NodeState {
    ...
    pub fn register_node_id(
        &mut self,
        mac: [u8; 6],
        id: heapless::String<{ crate::topology::NODE_ID_LEN }>,
    ) {
        self.node_ids.insert(mac, id);
    }
